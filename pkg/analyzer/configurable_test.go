...
func TestConfigurableAnalyzerDeferOnly(t *testing.T) {
	...
	packages := []string{
		"github.com/aii-nozomu-oki/sqlclosecheck/pkg/analyzer/testdata/rows",
		"github.com/aii-nozomu-oki/sqlclosecheck/pkg/analyzer/testdata/stmt",
		"github.com/aii-nozomu-oki/sqlclosecheck/pkg/analyzer/testdata/pgx",
	}
...
func XTestConfigurableAnalyzerClosed(t *testing.T) {
	...
	packages := []string{
		"github.com/aii-nozomu-oki/sqlclosecheck/pkg/analyzer/testdata/closed",
	}
